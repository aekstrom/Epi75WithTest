...
<asp:Content ContentPlaceHolderID="FullRegion" runat="server">
    ...
    <script type="text/javascript">
        function Sort(order, listElementId) {
            ...
            var arr = $.map(listItems, function (li, index) {
                return { item: li, title: $("a", li).attr("title"), index: $("a", li).attr("id") };  
            });
	...
	<div class="epiemptybackground">
        <EPiServerUI:TabStrip id="menuTab" runat="server" GeneratesPostBack="false" targetid="tabView" CssClass="epi-tinyTabs">
			<EPiServerUI:Tab Text="/admin/menutabs/admin" runat="server" id="AdminTab"/>
			<EPiServerUI:Tab Text="/admin/menutabs/config" runat="server" id="ConfigTab"/>
            <EPiServerUI:Tab Text="/admin/menutabs/contenttypes" runat="server" id="ContentTypeTab"/>
                ...
                <ul>
                    ...
                    <li class="epi-navigation-standard epi-navigation-selected">
                        ...
                        <ul id="admin_propertyConfig_sub">
                            ...
                            <li>
                                <a class="epi-navigation-global_user_settings_shell_search " href="EditDynProp.aspx">
