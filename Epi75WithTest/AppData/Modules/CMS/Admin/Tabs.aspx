        ...
        <asp:GridView
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="<%$ Resources: EPiServer, button.edit %>" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <EPiServerUI:ToolButton CommandName="Edit" SkinID="Edit" CausesValidation="false" ToolTip="<%$ Resources: EPiServer, button.edit %>" Enabled="<%# ButtonEnabled( Container.DataItemIndex )%>" runat="server" /> 
                    </ItemTemplate>
                    <EditItemTemplate>
                        <EPiServerUI:ToolButton CommandName="Update" SkinID="Save" CausesValidation="true" ToolTip="<%$ Resources: EPiServer, button.save %>" Enabled="<%# ButtonEnabled( Container.DataItemIndex )%>" runat="server" /><EPiServerUI:ToolButton CommandName="Cancel" SkinID="Cancel" CausesValidation="false" ToolTip="<%$ Resources: EPiServer, button.cancel %>" Enabled="<%# ButtonEnabled( Container.DataItemIndex )%>" runat="server" />
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="<%$ Resources: EPiServer, button.delete %>" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <EPiServerUI:ToolButton ID="deleteTool" CommandName="Delete" SkinID="Delete" EnableClientConfirm="true" ToolTip="<%$ Resources: EPiServer, button.delete %>" Enabled='<%# !(bool)Eval("IsSystemTab") && ButtonEnabled( Container.DataItemIndex )%>' runat="server" /> 
