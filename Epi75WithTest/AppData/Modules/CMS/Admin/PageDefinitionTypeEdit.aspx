<%@ Page Language="c#" Codebehind="PageDefinitionTypeEdit.aspx.cs" AutoEventWireup="False" Inherits="EPiServer.UI.Admin.PageDefinitionTypeEdit"  Title="PageDefinítionTypeEdit" %>
...
<asp:Content ContentPlaceHolderID="MainRegion" runat="server">
    ...
    <div class="epi-formArea">
        <div class="epi-size10">
            <div>
                <asp:Label runat="server" AssociatedControlID="typeName" Text="<%$ Resources: EPiServer, admin.PageDefinitionTypeEdit.namecaption %>" />
                ...
                <episerver:xmlnamevalidator controltovalidate="typeName" runat="server" displayname="#namecaption" id="Xmlnamevalidator1">*</episerver:xmlnamevalidator>
            </div>
                        ...
                        <asp:Repeater DataSource="<%# ((KeyValuePair<Type, IEnumerable<PropertySettingsWrapper>>)Container.DataItem).Value %>" runat="server">
                            <HeaderTemplate>
                                <table class="epi-default" style="width: 100%;">
                                    <tr>
                                        <th><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources: EPiServer, admin.pagedefinitiontypeedit.name %>" /></th>
                                        <th><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources: EPiServer, admin.pagedefinitiontypeedit.description %>" /></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton runat="server" 
                                                        Visible="<%# !((PropertySettingsWrapper)Container.DataItem).IsDefault %>"
                                        ...
                                        <strong><asp:Literal runat="server"
                                                     Visible="<%# ((PropertySettingsWrapper)Container.DataItem).IsDefault %>"
                                                     Text="<%$ Resources: EPiServer, admin.pagedefinitiontypeedit.isdefault %>" /></strong>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
