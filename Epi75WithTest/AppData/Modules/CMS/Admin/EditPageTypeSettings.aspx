...
<asp:Content ContentPlaceHolderID="MainRegion" runat="server">
            ...
            <asp:Panel ID="GeneralSettings" runat="server">
                <div class="epi-formArea">
                    ...
                    <fieldset>
                        ...
                        <div>
                            <EPiServerUI:MembershipAccessLevel CssClass="EPEdit-sidAccessLevel" runat="server"
                                ID="PageTypeAccess" EnableSelectAll="false" />
    ...
    <div class="epi-buttonContainer">
        <EPiServerUI:ToolButton DisablePageLeaveCheck="true" ID="DeleteButton" runat="server" Text="<%$ Resources: EPiServer, button.delete %>" ToolTip="<%$ Resources: EPiServer, button.delete %>" SkinID="Delete" OnClick="DeleteButton_Click" CausesValidation="False" />
        <EPiServerUI:ToolButton DisablePageLeaveCheck="true" ID="ApplyButton" runat="server" Text="<%$ Resources: EPiServer, button.save %>" ToolTip="<%$ Resources: EPiServer, button.save %>" SkinID="Save" OnClick="ApplyButton_Click" />
        ...
        <EPiServerUI:ToolButton ID="CancelButton" runat="server" Text="<%$ Resources: EPiServer, button.cancel %>" ToolTip="<%$ Resources: EPiServer, button.cancel %>" SkinID="Cancel" OnClick="CancelButton_Click" CausesValidation="False" />
    </div>
