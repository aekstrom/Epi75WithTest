...
<asp:Content runat="server" ContentPlaceHolderID="FullRegion">
    <div class="epi-globalNavigationContainer">
        <sc:ShellMenu runat="server" SelectionPath="/global/cms/admin" Area="CMS" ID="Menu" />
    </div>
    <EPiServerUI:DynamicTable runat="server" NumberOfColumns="3" CellPadding="0" CellSpacing="0" ID="DynamicTable2" KeyName="EPAdminFramework">
        <EPiServerUI:DynamicRow runat="server" ID="DynamicRow3">
            <EPiServerUI:DynamicCell runat="server" CssClass="epi-globalNavigationLegacyWrapper" ID="DynamicCell5" Colspan="3">
