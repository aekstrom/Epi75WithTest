(function (tinymce, $) {
    tinymce.create('tinymce.plugins.epipersonalizedcontent', {
            ...
            */
            var pluginInit = function (ed) {
                ...
                $(ed.dom.doc).click(function (e) {
                    ...
                    if (ed.dom.hasClass(e.target, "epi_pc_editBtn") && (e.button === 0)) {
        ...
        */
        ...
        /**
        * Focus on a PC regarding to the event target
        *
        * @param {Event} e The event object.
        */
        _focusSelection: function (e) {
            ...
            this.ed.focus();
            if (!tinymce.isIE) {
                this.ed.selection.select(e.target);
            }
            else {
        ...
        */
        _getCommonAncestor: function () {
            ...
            if (tinymce.isIE || this.ed.selection.getStart() == this.ed.selection.getEnd()) {
