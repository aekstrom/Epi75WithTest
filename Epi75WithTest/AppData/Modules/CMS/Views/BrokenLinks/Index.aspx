        ...
        <fieldset>
            ...
            <div class="epi-size10">
                <div>
                    ...
                    <%=Html.TextBox("rootPageName", EPiServer.DataFactory.Instance.GetPage(new EPiServer.Core.PageReference(Model.RootPageId)).PageName, new { @readonly = true, @class = "epi-disabledTextBox episize240" })%>
