...
EPi.TreeView = function( treeContainerId )
{
    ...
    this._Init = function(initCallback)
    {
        if (!_initialized)
        {
            ...
            EPi.AddEventListener(this._treeContainer, "click", function(e) { self.NodeClicked(e) });
            EPi.AddEventListener(this._treeContainer, "mousedown", function(e) { self.MouseDown(e) });
            EPi.AddEventListener(this._treeContainer, "mouseover", function(e) { self.MouseOver(e) });
            EPi.AddEventListener(this._treeContainer, "mouseout", function(e) { self.MouseOut(e) });
            EPi.AddEventListener(this._treeContainer, "mouseup", function(e) { self.MouseUp(e) });
            EPi.AddEventListener(this._treeContainer, "contextmenu", function(e) { self.ContextMenu(e) });
            EPi.AddEventListener(document, "mousemove", function(e) { self.MouseMove(e) } );
            EPi.AddEventListener(document, "keydown", function(e) { self.KeyDown(e) } );
            EPi.AddEventListener(document, "click", this.DocumentClick);


            this._selectedNodes.addCallback = function(item) { self.HighLightNode(item) };
            this._selectedNodes.deleteCallback = function(item) { self.LowLightNode(item) };
