define("epi/patch/dojo/store/Observable", ["dojo/_base/kernel", "dojo/_base/lang", "dojo/_base/Deferred", "dojo/_base/array"
                    ...
                    if (listeners.push(listener) == 1) {
                        ...
                        queryUpdaters.push(queryUpdater = function (changed, existingId) {
                            Deferred.when(results, function (resultsArray) {
                                ...
                                /*****************************************
                                 ** BEGIN EPiServer Patch               **
                                 *****************************************/

                                if (queryUpdaters.indexOf(queryUpdater) === -1)
                                {
                                    // Query updater has been removed before result was returned
                                    // https://bugs.dojotoolkit.org/ticket/17430
                                 	return;
                                }
