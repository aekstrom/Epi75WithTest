...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div data-dojo-type="dijit/layout/BorderContainer" id="rootContainer" gutters="false" style="padding: 0;height: 100%; width: 100%;">
        ...
        <div id="applicationContainer" class="epi-applicationContainer" data-dojo-type="epi/shell/widget/ApplicationContentPane" region="center"></div>
    </div>
    <% } else { %>
        <% if (Model.GlobalNavigationMenuType.Equals(GlobalNavigationMenuType.Static)) { %>
    ...
    <% } %>
        <div id="applicationContainer" class="epi-applicationContainer" data-dojo-type="epi/shell/widget/Application" style="height: 100%"></div>
    <% } %>
</asp:Content>
