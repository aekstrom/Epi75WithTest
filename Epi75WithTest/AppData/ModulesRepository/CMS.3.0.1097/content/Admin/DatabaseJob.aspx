...
<asp:Content ContentPlaceHolderID="MainRegion" runat="server">
    ...
    <asp:Panel ID="TabView" runat="server">
        ...
        <asp:Panel ID="Log" runat="server" CssClass="epi-padding">
            <br />
            <asp:DataGrid ID="logGrid" AutoGenerateColumns="False" runat="server" PageSize="10"
                ...
                <Columns>
                    <asp:BoundColumn HeaderStyle-CssClass="epitableheading" HeaderText="#logdate" DataField="Exec">
                    </asp:BoundColumn>
                    <asp:BoundColumn HeaderStyle-CssClass="epitableheading" HeaderText="#logstatus" DataField="StatusMessage">
                    </asp:BoundColumn>
                    <asp:BoundColumn HeaderStyle-CssClass="epitableheading" HeaderText="#logmessage"
                        DataField="Text"></asp:BoundColumn>
                </Columns>
            </asp:DataGrid>
        </asp:Panel>
    </asp:Panel>
