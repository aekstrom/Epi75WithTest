            ...
            <asp:TemplateColumn ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <EPiServerUI:ToolButton
                        ...
                        OnClientClick='<%#OpenDeleteDialog((string)DataBinder.Eval(Container.DataItem, "Name"), SecurityEntityType.Role, Server.UrlEncode((string)DataBinder.Eval(Container.DataItem, "ProviderName")))%>'
