	...
	function addRows(UserOrGroupName, isUserOrGroup)
	{
        ...
        frmSpanRow.onclick = function() { highlightRow(EPiClientIdentityCounter, false)};                       
	...
	function insertTableCell( oRow, nAccess, EPiClientIdentityCounter,isUserOrGroup, iAccessLevelCount, disabled ) {
    	...
    	{            	
    	    ...
    	    frmCheckbox.onclick     = function(){ highlightRow(EPiClientIdentityCounter, true); };
    	    frmCheckbox.ondblclick  = function() { return SecEnableAccess(clientID + '_p_' + EPiClientIdentityCounter, nAccess, EPiClientIdentityCounter);};
