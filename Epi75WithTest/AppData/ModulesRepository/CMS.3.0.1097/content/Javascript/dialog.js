...
{
    // Raised from a document node
    var win = EPi.GetDocumentWindow(this);
    if (win && win.top.EPiOpenedDialog) {
        win.top.EPiOpenedDialog._SetFocus();
    }
};
...
_p._TimeoutCheck = function() {
    var epiDialog = window.top.EPiOpenedDialog;
